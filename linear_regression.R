...
## This model's estimeate coefficient for 'metro' is -1.6526 which means metro has negative correlation 
## with energy. The Pr value of metro is 0.031 that means metro is a significant variable.
## The R squared is 0.09714 and the Adjusted R-squared is 0.07751.The both are not so high.
