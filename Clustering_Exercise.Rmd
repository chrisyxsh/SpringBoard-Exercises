...
The wssplot function compute average (Euclidean) distance between all cluster members with clusters' number from 1 to 15.
...
Through barplot with NbClust function, we can see when number of clusters is 3, 
it has been chosen by more than 14 criteria which is obviously higher than other numbers.

Then this methos suggest 3 clusters.
